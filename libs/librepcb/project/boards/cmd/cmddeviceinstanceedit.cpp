...
void CmdDeviceInstanceEdit::setPosition(
    const Point& pos,
...
void CmdDeviceInstanceEdit::translate(
...
void CmdDeviceInstanceEdit::setRotation(
    const Angle& angle,
    bool immediate) noexcept {
  Q_ASSERT(!wasEverExecuted());
  mNewRotation = angle;
...
void CmdDeviceInstanceEdit::rotate(
    const Angle& angle,
    const Point& center,
    bool immediate) noexcept {
  Q_ASSERT(!wasEverExecuted());
...
void CmdDeviceInstanceEdit::mirror(
    const Point& center,
