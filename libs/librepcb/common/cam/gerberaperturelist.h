...
private:
  ...
  static QString generateCircle(
      const UnsignedLength& dia,
      const UnsignedLength& hole) noexcept;
  static QString generateRect(
      const UnsignedLength& w,
      const UnsignedLength& h,
      const UnsignedLength& hole) noexcept;
  static QString generateObround(
      const UnsignedLength& w,
      const UnsignedLength& h,
      const UnsignedLength& hole) noexcept;
  static QString generateRegularPolygon(
      const UnsignedLength& dia,
      int n,
      const Angle& rot,
      const UnsignedLength& hole) noexcept;
  ...
  static QString generateRotatedRect(
      const UnsignedLength& w,
      const UnsignedLength& h,
      const Angle& rot,
      const UnsignedLength& hole) noexcept;
  static QString generateRotatedObround(
      const UnsignedLength& w,
      const UnsignedLength& h,
      const Angle& rot,
      const UnsignedLength& hole) noexcept;
  static QString generateRotatedOctagon(
      const UnsignedLength& w,
      const UnsignedLength& h,
      const UnsignedLength& edge,
      const Angle& rot,
