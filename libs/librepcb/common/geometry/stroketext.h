...
template <>
inline StrokeTextSpacing deserializeFromSExpression(
...
using StrokeTextList = SerializableObjectList<
    StrokeText,
    StrokeTextListNameProvider,
    StrokeText::Event>;
using CmdStrokeTextInsert = CmdListElementInsert<
    StrokeText,
    StrokeTextListNameProvider,
    StrokeText::Event>;
using CmdStrokeTextRemove = CmdListElementRemove<
    StrokeText,
    StrokeTextListNameProvider,
    StrokeText::Event>;
using CmdStrokeTextsSwap = CmdListElementsSwap<
    StrokeText,
    StrokeTextListNameProvider,
    StrokeText::Event>;
